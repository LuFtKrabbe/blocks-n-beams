...
const AddAddressModal: FC<EditAddressModalProps> = ({
  ...
  const onFinish = (values: ChangeAddressForm) => {
    ...
    const updateActions: CustomerUpdateAction[] = [{ action: 'addAddress', address: values }];
  ...
  return (
    <Modal title="Edit Address" open={isAddAddressModalOpen} onCancel={handleCancel} footer={[]}>
      <Form
        form={form}
        name="addAddressForm"
        labelCol={{ span: 8 }}
